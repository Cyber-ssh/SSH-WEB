...
wget https://raw.githubusercont.com/Cyber-ssh/SSH-WEB/main/sshplus.zip.001 > /dev/null 2>&1
wget https://raw.githubusercont.com/Cyber-ssh/SSH-WEB/main/sshplus.zip.002 > /dev/null 2>&1
wget https://raw.githubusercont.com/Cyber-ssh/SSH-WEB/main/sshplus.zip.003 > /dev/null 2>&1
...
clear
wget https://raw.githubusercont.com/Cyber-ssh/SSH-WEB/main/sincpainel.zip > /dev/null 2>&1
